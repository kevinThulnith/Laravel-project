                        ...
                        <form class="mt-6 space-y-6" id="submitForm">
                            ...
                            <div>
                                ...
                                <x-text-input id="price" name="price" type="text" class="mt-1 block w-full"
                                    ...
                                    title="Enter a number with up to two digits after the decimal point." required />
                                @error('price')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <x-text-input id="quantity" name="quantity" type="text" class="mt-1 block w-full"
                                    placeholder="XXX" pattern="\d*" title="Only numbers are allowed" required />
                                @error('quantity')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                <button type="submit"
                                    class="bg-gray-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add
                                    Product</button>
                            </div>
                        </form>
                        ...
                        <script>
                            document.getElementById('submitForm').addEventListener('submit', async function(e) {
                                ...
                                try {
                                    ...
                                    alert('Product aded succesfully');
                                } catch (error) {
